...
def makeChemProto(name='hydra'):
        ...
        Adot.expr="0.01*(x0^2/x1)-0.001*x0"
        Bdot.expr="0*x0+0.01*x0^2-0.01*x1"
...
#    A.concInit=1
#    B.concInit=10
    moose.element('/model/chem/dend/A').vec[500].nInit=1.1
    #moose.element('/model/chem/dend/B').vec[25].nInit=0
    #A.nInit=1
    #B.nInit=15
    for i in range(0,499):
        moose.element('/model/chem/dend/A').vec[i].diffConst=1e-11
