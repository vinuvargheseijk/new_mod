  ...
  #  imgplot = plt.imshow( img )
    ...
    for j in list:
      ...
      for i in range(len(a.vec.conc)):
        anC.append(2.0*diffL*(4.0/(math.sqrt(4*math.pi*a.diffConst*4)))*math.exp(-(mm[i].Coordinates[0]**2)/(4*a.diffConst*4)))
        ...
        #print mm[i].Coordinates[0]
           anC2.append(4.0*diffL**2*(4.0/(4*numpy.pi*j[1]*numpy.sqrt(a.diffConst*a.diffConst)))*numpy.exp(-(mm[i].Coordinates[0]**2)/(4*a.diffConst*j[1])-(mm[k].Coordinates[0]**2)/(4*a.diffConst*j[1])))
           v2d[i][k] = 4.0*diffL**2*(4.0/(4*numpy.pi*j[1]*numpy.sqrt(a.diffConst*a.diffConst)))*numpy.exp(-(mm[i].Coordinates[0]**2)/(4*a.diffConst*j[1])-(mm[k].Coordinates[0]**2)/(4*a.diffConst*j[1]))
        ...
        #print (3/(numpy.sqrt(4*numpy.pi*a.diffConst*1)))*numpy.exp(-(mm[i].Coordinates[0]**2)/(4*a.diffConst*1))
           firstCell = diffL*(4.0/(math.sqrt(4*math.pi*a.diffConst*4)))*math.exp(-(mm[0].Coordinates[0]**2)/(4*a.diffConst*4))
           firstCell2 = 2*diffL**2*(4.0/(4*numpy.pi*j[1]*numpy.sqrt(a.diffConst*a.diffConst)))*numpy.exp(-(mm[0].Coordinates[0]**2)/(4*a.diffConst*j[1])-(mm[0].Coordinates[0]**2)/(4*a.diffConst*j[1]))
      print 'analaytical sum 1D is',sum(anC)-firstCell, 'max of anC is', max(anC)
      print 'analaytical sum 2D is',sum(anC2)-2*firstCell-firstCell2/2, 'max of anC2 is', max(anC2), firstCell, firstCell2
      plt.plot(anC)
      plt.plot(anC2)
    raw_input()
    plt.figure(2)
